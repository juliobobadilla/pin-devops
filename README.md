...
Para instalar el entorno de desarrollo se debe ejecutar dentro del directorio del proyecto el siguiente comando:
...
| POSTGRES_PORT               | 5432                                           |
| POSTGRES_DB                 | 'xxxxxx'                                       |
| POSTGRES_DBHOST             | xxxxx-db-1                                  |
| DATABASE_URL                | 'postgresql://postgres:example@db:5432/xxxxx' |
